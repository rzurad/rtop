...
var cpuLine = grid.set(0, 0, 5, 12, contrib.line, {
  showNthLabel: 5,
  maxY: 100,
  label: 'CPU History',
  showLegend: true,
...
var memLine = grid.set(5, 0, 4, 8, contrib.line, {
  showNthLabel: 5,
  maxY: 100,
...
var memDonut = grid.set(5, 8, 4, 4, contrib.donut, {
  radius: 8,
  arcWidth: 3,
  yPadding: 2,
  remainColor: 'black',
...
/*
var swapDonut = grid.set(7, 8, 3, 4, contrib.donut, {
  radius: 8,
  arcWidth: 3,
  yPadding: 2,
  remainColor: 'black',
...
var netSpark = grid.set(9, 0, 3, 8, contrib.sparkline, {
...
var diskDonut = grid.set(9, 8, 3, 4, contrib.donut, {
  radius: 8,
  arcWidth: 3,
  yPadding: 2,
  remainColor: 'black',
